...
public:
    ...
    void begin(void), setAddrWindow(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1),
...
private:
    ...
    uint32_t _cs, _dc, _rst, _mosi, _miso, _sclk, mosipinmask, clkpinmask, cspinmask, dcpinmask;
