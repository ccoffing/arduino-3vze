...
public:
    ...
    void drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color),
        ...
        drawGrayscaleBitmap(int16_t x, int16_t y, const uint8_t bitmap[], const uint8_t mask[],
            int16_t w, int16_t h),
        drawGrayscaleBitmap(
        ...
        drawRGBBitmap(int16_t x, int16_t y, const uint16_t bitmap[], const uint8_t mask[],
            int16_t w, int16_t h),
    ...
    // get current cursor position (get rotation safe maximum values, using: width() for x, height()
    // for y)
